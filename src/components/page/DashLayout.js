        ...
        <div className="px-3 py-3 lg:px-5 lg:pl-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="pt-2 relative mx-auto text-gray-600">
              <input className="border border-gray-300 bg-white h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none"
      ...
      >
        <div className="h-full px-3 pb-4 overflow-y-auto dark:bg-gray-800" style={{backgroundColor: '#1B1A47'}}>
          <ul className="space-y-2 mt-4 font-medium">
            ...
            <li style={dynamicStyle(4)}>
              <Link
                href="/admin/baskets"
                className="flex items-center p-2 text-white hover:text-black rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
                onClick={() => setId(4)}
              >
                <svg className="flex-shrink-0 w-5 h-5 text-white transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
