        ...
        onClose={() => {
            ...
            <Modal.Header className={toggle == "SELL" ? "bg-orange-500" : "bg-cyan-800"}>
                ...
                <label className="relative inline-flex items-center mb-4 cursor-pointer">
                    <input type="checkbox" value={toggle} onClick={handleTransType} class="sr-only peer" />
                    ...
                    <span class="ml-3 text-sm font-medium text-white dark:text-gray-300">{toggle}</span>
                </label>
